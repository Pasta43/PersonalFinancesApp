...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { amount: @movement.amount, category_id: @movement.category_id, description: @movement.description, movement_type: @movement.movement_type, user_id: @movement.user_id } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { amount: @movement.amount, category_id: @movement.category_id, description: @movement.description, movement_type: @movement.movement_type, user_id: @movement.user_id } }
